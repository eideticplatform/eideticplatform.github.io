...
myRadio :
    ...
    -> List (Html.Html msg)
    -> Html.Html msg
myRadio checked options inputAttributes children =
    let
        hideRadio =
            -- hides the radio input element, only showing the bootstrap button
            Attributes.attribute "data-toggle" "button"
    in
        Html.label
            ...
            (Html.input ([ Attributes.type_ "radio", Attributes.checked checked, Attributes.autocomplete False ] ++ inputAttributes) [] :: children)
