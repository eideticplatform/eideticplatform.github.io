...
myRadio : Bool -> List (Button.Option msg) -> List (Html.Attribute msg) -> List (Html.Html msg) -> RadioButtonItem msg
myRadio checked inputAttributes options children =
    Button.myRadio checked inputAttributes options children |> RadioButtonItem
