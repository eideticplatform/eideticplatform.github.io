...
var _kirchner$form_validation$Validate$Invalid = F2(
	function (a, b) {
...
var _kirchner$form_validation$Validate$unchecked = function (a) {
	return _kirchner$form_validation$Validate$Unchecked(a);
};
...
var _kirchner$form_validation$Validate$atLeast = F3(
	function (minimalLength, error, value) {
		return A3(
			_kirchner$form_validation$Validate$satisfies,
			function (string) {
				return _elm_lang$core$Native_Utils.cmp(
					minimalLength,
					_elm_lang$core$String$length(string)) < 1;
			},
			error,
			value);
	});
var _kirchner$form_validation$Validate$consistsOfLetters = F2(
	function (error, value) {
		...
		return A3(_kirchner$form_validation$Validate$satisfies, onlyLetters, error, value);
	});
var _kirchner$form_validation$Validate$isEmail = F2(
	function (error, value) {
		var emailRegex = _elm_lang$core$Regex$caseInsensitive(
		...
		var validEmail = function (string) {
			return A2(_elm_lang$core$Regex$contains, emailRegex, string);
		};
		return A3(_kirchner$form_validation$Validate$satisfies, validEmail, error, value);
	});
...
var _kirchner$form_validation$Validate$mapErrors = F2(
	function (f, value) {
		var _p18 = value;
		switch (_p18.ctor) {
			case 'Empty':
				return _kirchner$form_validation$Validate$Empty;
			case 'Unchecked':
				return _kirchner$form_validation$Validate$Unchecked(_p18._0);
			case 'Valid':
				return _kirchner$form_validation$Validate$Valid(_p18._0);
			default:
				return A2(
					_kirchner$form_validation$Validate$Invalid,
					_p18._0,
					A2(_elm_lang$core$Set$map, f, _p18._1));
		}
	});
...
var _user$project$Convenience$traverse = function (f) {
	var step = F2(
		function (e, acc) {
			var _p0 = f(e);
			if (_p0.ctor === 'Nothing') {
...
var _user$project$Convenience$isNothing = function (m) {
	var _p1 = m;
	if (_p1.ctor === 'Nothing') {
		return true;
	} else {
...
var _user$project$Main$photosPriceRanges = _elm_lang$core$Dict$fromList(
	{
		ctor: '::',
		_0: {
			ctor: '_Tuple2',
			_0: 10,
			_1: {ctor: '_Tuple2', _0: 3, _1: 20}
		},
		_1: {
			ctor: '::',
			_0: {
...
var _user$project$Main$photosPerMonthEnum = A2(
	_elm_lang$core$List$map,
	_elm_lang$core$Tuple$first,
	_elm_lang$core$Dict$toList(_user$project$Main$photosPriceRanges));
...
var _user$project$Main$entrance = _elm_lang$html$Html_Attributes$class('fadeInDown animated');
var _user$project$Main$emptyFeedback = {
	ctor: '::',
	_0: A2(
...
var _user$project$Main$invalidFeedback = function (field) {
	return A2(
		...
		A2(
			...
			function (invalidBecause) {
				return {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _user$project$Main$entrance,
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
			...
			_kirchner$form_validation$Validate$errors(field)));
};
...
var _user$project$Main$animation = _elm_lang$html$Html_Attributes$class('animated fadeIn');
...
var _user$project$Main$errorIndexOfReasonablePrice = function (model) {
	return A2(
		_elm_lang$core$Maybe$withDefault,
		-1,
		A2(
			...
			reasonablePrice: function () {
				var _p3 = A2(
					...
					A2(
						_elm_lang$core$Maybe$andThen,
						function (k) {
							return A2(_elm_lang$core$Dict$get, k, _user$project$Main$photosPriceRanges);
						},
				...
				return A2(
					_kirchner$form_validation$Validate$satisfies,
					function (n) {
						var _p4 = _elm_lang$core$String$toInt(n);
						if (_p4.ctor === 'Ok') {
							var _p5 = _p4._0;
							return (_elm_lang$core$Native_Utils.cmp(_p5, mini) > -1) && (_elm_lang$core$Native_Utils.cmp(_p5, maxi) < 1);
						} else {
							return false;
						}
					},
					{
						...
						_1: A2(
							...
							A2(
								_elm_lang$core$Basics_ops['++'],
								_elm_lang$core$Basics$toString(mini),
								A2(
									_elm_lang$core$Basics_ops['++'],
									' and ',
									_elm_lang$core$Basics$toString(maxi))))
					});
			}()(
				A3(
					_kirchner$form_validation$Validate$satisfies,
					...
					{ctor: '_Tuple2', _0: 2, _1: 'You must select the number of photos first'},
					A3(
						_kirchner$form_validation$Validate$satisfies,
						function (s) {
							var _p7 = _elm_lang$core$String$toInt(s);
							if (_p7.ctor === 'Ok') {
								return true;
							} else {
								return false;
						...
						{ctor: '_Tuple2', _0: 1, _1: 'This is not a valid price'},
						A2(
							_kirchner$form_validation$Validate$isNotEmpty,
							{ctor: '_Tuple2', _0: 0, _1: 'Price must not be empty'},
...
var _user$project$Main$urlUpdate = F2(
	function (location, model) {
		var _p8 = _user$project$Main$decode(location);
		if (_p8.ctor === 'Nothing') {
			return {
				ctor: '_Tuple2',
...
var _user$project$Main$Price = {ctor: 'Price'};
...
var _user$project$Main$update = F2(
	function (msg, model) {
		...
		switch (_p9.ctor) {
			case 'UrlChange':
				return A2(_user$project$Main$urlUpdate, _p9._0, model);
			case 'NavMsg':
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
				...
				return {
					...
					_0: function () {
						var newModel = _elm_lang$core$Native_Utils.update(
							model,
							{
								radioPhotosPerMonth: _kirchner$form_validation$Validate$valid(_p10),
								reasonablePrice: _kirchner$form_validation$Validate$uncheck(model.reasonablePrice)
							});
						return (_elm_lang$core$Native_Utils.cmp(
							_user$project$Main$errorIndexOfReasonablePrice(model),
							2) > -1) ? _elm_lang$core$Native_Utils.update(
							newModel,
							{
								reasonablePrice: _user$project$Main$validateModel(newModel).reasonablePrice
							}) : _elm_lang$core$Native_Utils.update(
							model,
							{
								radioPhotosPerMonth: _kirchner$form_validation$Validate$valid(_p10)
			...
			case 'RadioPaymentMsg':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							radioPaymentMethod: _kirchner$form_validation$Validate$valid(_p9._0)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			...
			case 'ConfirmPressed':
				...
				var validatedFormData = _user$project$Main$formData(validated);
				var valid = !_elm_lang$core$Native_Utils.eq(validatedFormData, _elm_lang$core$Maybe$Nothing);
				return {
					ctor: '_Tuple2',
			...
			case 'ChangeEmail':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							email: _kirchner$form_validation$Validate$unchecked(_p9._0)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'ChangePrice':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							reasonablePrice: _kirchner$form_validation$Validate$unchecked(_p9._0)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'Response':
			...
			case 'Delay':
				return A2(
					...
					{
						ctor: '::',
						_0: A3(_andrewMacmurray$elm_delay$Delay$after, _p9._0._0, _elm_lang$core$Time$millisecond, _p9._0._1),
						_1: {ctor: '[]'}
					});
			case 'Defocused':
				if (_p9._0.ctor === 'Email') {
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								email: _user$project$Main$validateModel(model).email
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				} else {
						...
						_0: function () {
							...
							return _elm_lang$core$Native_Utils.update(
								model,
								{
									...
									radioPhotosPerMonth: _elm_lang$core$Native_Utils.eq(
										_user$project$Main$errorIndexOfReasonablePrice(validated),
										2) ? A2(
			...
			case 'ValidateModel':
				return {
					ctor: '_Tuple2',
					_0: _user$project$Main$validateModel(model),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'ScrollTo':
				return {
...
var _user$project$Main$ValidateModel = {ctor: 'ValidateModel'};
var _user$project$Main$Defocused = function (a) {
	return {ctor: 'Defocused', _0: a};
};
var _user$project$Main$ChangePrice = function (a) {
	return {ctor: 'ChangePrice', _0: a};
};
var _user$project$Main$priceView = function (model) {
	return A2(
		_elm_lang$core$Basics_ops['++'],
		{
			ctor: '::',
		...
		_user$project$Main$invalidFeedback(model.reasonablePrice));
};
var _user$project$Main$ChangeEmail = function (a) {
	return {ctor: 'ChangeEmail', _0: a};
};
var _user$project$Main$emailView = function (model) {
	return A2(
		_elm_lang$core$Basics_ops['++'],
		{
			ctor: '::',
											...
											_0: _rundis$elm_bootstrap$Bootstrap_Form_Input$attrs(
												{
													...
													_1: {
														...
														_1: {
															ctor: '::',
															_0: _elm_lang$html$Html_Events$onBlur(
																_user$project$Main$Defocused(_user$project$Main$Email)),
															_1: {ctor: '[]'}
														}
													}
												}),
		...
		A2(
			_elm_lang$core$Basics_ops['++'],
			_user$project$Main$invalidFeedback(model.email),
			{
				ctor: '::',
				_0: A2(
					...
					function () {
						...
						if (_p15.ctor === 'Just') {
							...
							return {
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('isUp'),
								_1: {ctor: '[]'}
							};
						}
					}(),
...
var _user$project$Main$radioPhotosView = F3(
	function (attrs, model, invalid) {
		return A2(
							...
							_elm_lang$core$Maybe$Just(n)),
						{
							...
							_1: {
								...
								_0: _rundis$elm_bootstrap$Bootstrap_Button$onClick(
									_user$project$Main$RadioPhotosMsg(n)),
								_1: {
									ctor: '::',
...
var _user$project$Main$radioPaymentView = F3(
	function (attrs, model, invalid) {
		return A2(
			_rundis$elm_bootstrap$Bootstrap_ButtonGroup$radioButtonGroup,
			attrs,
			A2(
				...
				function (method) {
					return A3(
						_rundis$elm_bootstrap$Bootstrap_ButtonGroup$radioButton,
						_elm_lang$core$Native_Utils.eq(
							_kirchner$form_validation$Validate$validValue(model.radioPaymentMethod),
							_elm_lang$core$Maybe$Just(method)),
						{
							...
							_1: {
								ctor: '::',
								_0: _rundis$elm_bootstrap$Bootstrap_Button$onClick(
									_user$project$Main$RadioPaymentMsg(method)),
								_1: {
									ctor: '::',
									_0: _rundis$elm_bootstrap$Bootstrap_Button$attrs(
										invalid ? {
...
var _user$project$Main$paymentView = function (model) {
	var invalid = model.confirmClicked && _elm_lang$core$Native_Utils.eq(model.radioPaymentMethod, _kirchner$form_validation$Validate$empty);
	return A2(
		_elm_lang$core$Basics_ops['++'],
		{
			ctor: '::',
	...
	return A2(
		_elm_lang$html$Html$main_,
		{
			...
			_1: {
				...
				_1: {
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('zoomIn animated'),
					_1: {ctor: '[]'}
				}
			}
		},
				...
				_0: A2(
					...
					A2(
						...
						A2(
							...
							{
								ctor: '::',
								_0: _user$project$Main$emailView(model),
								_1: {
									ctor: '::',
									_0: _user$project$Main$photosView(model),
									_1: {
										ctor: '::',
										_0: _user$project$Main$priceView(model),
										_1: {
											ctor: '::',
											_0: _user$project$Main$paymentView(model),
											_1: {ctor: '[]'}
										}
									}
								}
